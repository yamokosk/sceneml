...
/**************************************************************************
 *	Variable Attributes Builder
 **************************************************************************/
VariableProperties::VariableProperties(const TiXmlNode* node) :
	PropertiesBuilder(node, "VarialbleProperties")
{

}

void VariableProperties::createNewAttributes()
{
	PropertiesBuilder::createNewAttributes();
}

void VariableProperties::getAttributes()
{
	// Tag specific attributes and default values
	pc_->addPair( RequiredProperty("name") );
	pc_->addPair( RequiredProperty("type") );
	pc_->addPair( OptionalProperty("value") );

	// Parent class will get specific values
	PropertiesBuilder::getAttributes();
}

void VariableProperties::getParameters()
{
	// No parameters
...
void VariableProperties::verify()
{
	// Parent class will check that required properties have a value other than NO_DATA
	PropertiesBuilder::verify()
