...
void dGeomToMxArray(mxArray *array[], xode::Geom *obj)
{
	// Name
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	try {
		...
		SSWITCH( type )
		{
			...
			{
				// Get xode/ode object
				xode::GeomList_t allGeoms = g_scene.get()->getAllGeoms();
				xode::GeomList_t::iterator it = allGeoms.begin();
			...
			{
				// Get xode/ode object
				xode::ContactGeoms_t contactData = g_scene.get()->getContactData();
