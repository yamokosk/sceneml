...
namespace TinySG
{
    ...
    //-----------------------------------------------------------------------
    void Matrix3::FromAxisAngle (const Vector3& rkAxis, const Real& fRadians)
    {
    ...
    //-----------------------------------------------------------------------
    bool Matrix3::ToEulerAnglesXYZ (Real& rfYAngle, Real& rfPAngle,
        Real& rfRAngle) const
    {
        // rot =  cy*cz          -cy*sz           sy
    ...
    //-----------------------------------------------------------------------
    bool Matrix3::ToEulerAnglesXZY (Real& rfYAngle, Real& rfPAngle,
        Real& rfRAngle) const
    {
        // rot =  cy*cz          -sz              cz*sy
    ...
    //-----------------------------------------------------------------------
    bool Matrix3::ToEulerAnglesYXZ (Real& rfYAngle, Real& rfPAngle,
        Real& rfRAngle) const
    {
    ...
    //-----------------------------------------------------------------------
    bool Matrix3::ToEulerAnglesYZX (Real& rfYAngle, Real& rfPAngle,
        Real& rfRAngle) const
    {
    ...
    //-----------------------------------------------------------------------
    bool Matrix3::ToEulerAnglesZXY (Real& rfYAngle, Real& rfPAngle,
        Real& rfRAngle) const
    {
    ...
    //-----------------------------------------------------------------------
    bool Matrix3::ToEulerAnglesZYX (Real& rfYAngle, Real& rfPAngle,
        Real& rfRAngle) const
    {
    ...
    //-----------------------------------------------------------------------
    void Matrix3::FromEulerAnglesXYZ (const Real& fYAngle, const Real& fPAngle,
        const Real& fRAngle)
    {
        Real fCos, fSin;
    ...
    //-----------------------------------------------------------------------
    void Matrix3::FromEulerAnglesXZY (const Real& fYAngle, const Real& fPAngle,
        const Real& fRAngle)
    {
        Real fCos, fSin;
    ...
    //-----------------------------------------------------------------------
    void Matrix3::FromEulerAnglesYXZ (const Real& fYAngle, const Real& fPAngle,
        const Real& fRAngle)
    {
        Real fCos, fSin;
    ...
    //-----------------------------------------------------------------------
    void Matrix3::FromEulerAnglesYZX (const Real& fYAngle, const Real& fPAngle,
        const Real& fRAngle)
    {
        Real fCos, fSin;
    ...
    //-----------------------------------------------------------------------
    void Matrix3::FromEulerAnglesZXY (const Real& fYAngle, const Real& fPAngle,
        const Real& fRAngle)
    {
        Real fCos, fSin;
    ...
    //-----------------------------------------------------------------------
    void Matrix3::FromEulerAnglesZYX (const Real& fYAngle, const Real& fPAngle,
        const Real& fRAngle)
    {
        Real fCos, fSin;
