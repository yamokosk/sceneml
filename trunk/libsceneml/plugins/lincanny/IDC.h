...
const uint8_t	VertexVertexTest	= 001b;
const uint8_t	EdgeEdgeTest		= 010b;
const uint8_t	VertexEdgeTest		= 011b;
const uint8_t	FaceFaceTest		= 100b;
const uint8_t	VertexFaceTest		= 101b;
const uint8_t	EdgeFaceTest		= 110b;
