...
if ( WROTE_COMPILE_M )
	...
	if (WIN32)
		...
		file( APPEND ${COMPILE_M}	"mexflags = '-g -DWIN32 -DXML_LIBRARY';\n")
		file( APPEND ${COMPILE_M}	"mexflags = [mexflags ' -Iinclude -I${ODE_HOME}/include -I${Boost_INCLUDE_DIRS} -I${XERCES_HOME}/include'];\n")
		file( APPEND ${COMPILE_M}	"mexflags = [mexflags ' -Llib -L${ODE_HOME}/lib -L${MUPARSER_HOME}/lib -L${XERCES_HOME}/lib'];\n")
		file( APPEND ${COMPILE_M}	"mexflags = [mexflags sprintf(' -l%s -lodeD -lxerces-c_2D -lmuparserD', libname)];\n")
	else (WIN32)
