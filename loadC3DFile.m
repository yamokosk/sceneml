function C3DDataStruct = loadC3DFile(FullFilename)

[Markers,VideoFrameRate,AnalogSignals,AnalogFrameRate,Event,ParameterGroup,CameraInfo,ResidualError] = ...
          readC3D(FullFilename);

C3DDataStruct.mData = Markers;
C3DDataStruct.err = ResidualError;

[nFrames,nMarkers,nDof] = size(C3DDataStruct.mData);
C3DDataStruct.nMarkers = nMarkers;
C3DDataStruct.nFrames = nFrames;
...
% Markers = zeros(3,Nmarkers,NvideoFrames);
